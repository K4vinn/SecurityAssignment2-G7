                        ...
                        <?php
                                ...
                                if(mysqli_num_rows($result1) > 0){
                                    while($row1 = mysqli_fetch_assoc($result1)){
                                        ...
                                        echo'<span class="word2"><p style="margin-top: 30px;">' . $row1['user_name'] . '</p></span>' .
                                            '<span class="word2">' . $row1['user_id'] . '</p></span>' .
                                            '<span class="word2">' . $row1['user_gender'] . '</p></span>' .
                                            '<span class="word2">' . $row1['user_dob'] . '</p></span>' .
                                            '<span class="word2">' . $row1['user_phoneNo'] . '</p></span>' .
                                            '<span class="word2">' . $row1['user_email'] . '</p></span>' .
                                            '<span class="word2">' . $row1['user_address'] . '</p></span>' .
                                            '<span class="word2">' . $row1['address_zip'] . '</p></span>' .
                                            '<span class="word2">' . $row1['address_city'] . '</p></span>' .
                                            '<span class="word2">' . $row1['address_state'] . '</p></span>';
                                    } 
                                }
                            ?> 
                    </div>
